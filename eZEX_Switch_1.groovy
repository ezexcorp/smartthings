 ...
 */
metadata {
    definition(name: "eZEX Switch 1", namespace: "eZEX", author: "eZEX Corp", ocfDeviceType: "oic.d.switch") {
        capability "Actuator"
        ...
        fingerprint profileId: "0104", inClusters: "0000, 0003, 0004, 0005, 0006", manufacturer: "eZEX Corp", model: "E220-KR1N0Z0-HA", deviceJoinName: "eZEX Switch 1"
    }
    ...
    tiles(scale: 2) {
        ...
        main "switch"
        details(["switch", "space", "on", "off", "switch1", "space", "refresh"])
    }
}
