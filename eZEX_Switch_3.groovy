 ...
 */
metadata {
    definition(name: "eZEX Switch 3", namespace: "eZEX", author: "eZEX Corp", ocfDeviceType: "oic.d.switch") {
        capability "Actuator"
        ...
        fingerprint profileId: "0104", inClusters: "0000, 0003, 0004, 0005, 0006", manufacturer: "eZEX Corp", model: "E220-KR3N0Z0-HA", deviceJoinName: "eZEX Switch 3"
    }
    ...
    tiles(scale: 2) {
        ...
        standardTile("switch1", "device.switch1", decoration: "flat", width: 2, height: 1) {
        ...
        standardTile("switch2", "device.switch2", decoration: "flat", width: 2, height: 1) {
        ...
        standardTile("switch3", "device.switch3", decoration: "flat", width: 2, height: 1) {
        ...
        standardTile("space", "device.space", decoration: "flat", width: 2, height: 1) {

        }

        main "switch"
        details(["switch", "switch1", "on", "off", "switch2", "switch3", "refresh"])
    }
}
...
def checkStatus() {
    if (state.sw1 == "off" && state.sw2 == "off" && state.sw3 == "off") {
        ...
        state.swAll = "on"
        if (state.sw1 == "on" && state.sw2 == "on" && state.sw3 == "on") {
            state.swOn = "disabled"
        } else {
            state.swOn = "default"
        }
