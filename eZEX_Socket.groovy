 ...
 */
metadata {
    definition(name: "eZEX Socket", namespace: "eZEX", author: "eZEX Corp", ocfDeviceType: "oic.d.smartplug") {
        capability "Actuator"
        ...
        fingerprint profileId: "0104", deviceId: "0051", inClusters: "0000, 0003, 0004, 0006, 0B04, 0702", manufacturer: "eZEX Corp", model: "E210-KR210Z1-HA"
        //outcluster제외
    }
    ...
    tiles(scale: 2) {
        multiAttributeTile(name:"switch", type: "lighting", width: 6, height: 4, canChangeIcon: true){
            tileAttribute ("device.switch", key: "PRIMARY_CONTROL") {
                attributeState "on", label:'${name}', action:"off", icon:"http://www.ezex.co.kr/img/st/icon_main_concent_on.png", backgroundColor:"#ffc000", nextState:"TurningOff"
                attributeState "off", label:'${name}', action:"on", icon:"http://www.ezex.co.kr/img/st/icon_main_concent_off.png", backgroundColor:"#ffffff", nextState:"TurningOn"
                attributeState "TurningOn", label:'Turning On', icon:"http://www.ezex.co.kr/img/st/icon_main_concent_on.png", backgroundColor:"#c49300", nextState:"TurningOff"
                attributeState "TurningOff", label:'Turning Off', icon:"http://www.ezex.co.kr/img/st/icon_main_concent_off.png", backgroundColor:"#8e6b00", nextState:"TurningOn"
            }
